...
public class TextTrack : TrackAsset
{
    ...
    {
        TextCutscenePlayer trackBinding = director.GetGenericBinding(this) as TextCutscenePlayer;
        ...
        driver.AddFromName<TextCutscenePlayer>(trackBinding.textDisplay.gameObject, "m_text");
