...
[ExecuteAlways]
public class MistTransparentObject : MonoBehaviour
{

    public MistZone fogVolume;
    ...
    void OnDisable()
    {
        ...
        if (fogVolume != null)
        {
            fogVolume.fogZone.UnregisterFogMat(mat);
        }
    }
    ...
    void CheckSettings()
    {
        ...
        if (fogVolume == null)
        {
            ...
            fogVolume = FindAnyObjectByType<MistZone>();
            if (fogVolume == null) return;
            // return;
        }
        fogVolume.fogZone.RegisterFogMat(thisRenderer.sharedMaterial);
        fogVolume.fogZone.UpdateMaterialProperties();
    }
}
