...
namespace GOAP
{
    public class ActionLanternExit : Action
    {
        ...
        public override void PreExecute()
        {
            ...
            agent.GetComponent<AgentActions>().AddEventBinding("ExitLantern", animFinishedEvent);
            occupier.ExitLantern();
            /*
            occupier.currentLantern.animator.ResetTrigger("ExitLantern");
            occupier.currentLantern.animator.SetTrigger("ExitLantern");
            brain.Animator.ResetTrigger("ExitLantern");
            brain.Animator.SetTrigger("ExitLantern");
